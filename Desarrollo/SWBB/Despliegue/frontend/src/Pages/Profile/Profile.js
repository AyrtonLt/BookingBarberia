...
const DetailCard = ({ customer }) => {
  ...
  return (
    <div style={{ width: "100%", margin: "1em 0px" }}>
      ...
      />
      <DetailCardRow title={"Fecha de Nacimiento"} value="19/09/1997" bg />
      <DetailCardRow title={"Correo Electrónico"} value={customer.eMail} />
      <DetailCardRow
  ...
  return !isLoading ? (
    ...
    >
      <ConfirmModal
        ...
        modalContent={"¿Estás seguro de eliminar?"}
      />
            ...
            {pageNumber == 1 ? (
              ...
              <>
                ...
                {customerAppointments && customerAppointments.length > 0 ? (
                  ...
                  <div>Aún no has concertado una cita</div>
                )}{" "}
                {/* ))} */}
              </>
            )}
